...
class SecondRoute extends StatelessWidget {
  ...
  var thirdRouteValue = "Hi Iam the Third route with passed args from second";
          ...
          child: Column(
            ...
            children: [
              GestureDetector(
                ...
                onTap: () {
                  Navigator.pushNamed(context,ThirdRoute.id,arguments: ThirdPageArguments(thirdRouteValue));
                },
                child: Text(
